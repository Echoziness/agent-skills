...
| Skill | Description |
|-------|-------------|
| [bilibili-reader](SKILL/bilibili-reader/) | 让 AI "观看" B 站视频——提取 AI 字幕、评论和视频元数据 |
| [simple-video-downloader](SKILL/simple-video-downloader/) | Video downloader powered by yt-dlp. Supports Bilibili, YouTube, Twitter, Twitch and 1700+ sites. |
...
1. Create a folder under `SKILL/` with your skill name
